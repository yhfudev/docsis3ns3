...
namespace ns3 {
  ...
  bool DocsisHeader::IsDataPacket() const {
    return m_fcType == kPacketPDU || m_fcType == kIsolationPacketPDU;
  }

  bool DocsisHeader::IsManagementPacket() const {
    return m_fcType == kMacSpecific && m_macType == kMacManagement;
  }
